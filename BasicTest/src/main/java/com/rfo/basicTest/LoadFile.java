...
import static com.rfo.basicTest.Editor.GO_UP;
import static com.rfo.basicTest.Editor.addDirMark;
import static com.rfo.basicTest.Editor.getDisplayPath;
import static com.rfo.basicTest.Editor.goUp;
import static com.rfo.basicTest.Editor.isMarkedDir;
import static com.rfo.basicTest.Editor.quote;
import static com.rfo.basicTest.Editor.stripDirMark;
...
public class LoadFile extends ListActivity {
	...
	private void FileLoader(String aFileName) {					// The user has selected a file to load, load it.
		...
		if (!aFileName.isEmpty() ) Settings.setLastLoadedProgramPath(mProgramPath, aFileName);//2018-01-04gt
